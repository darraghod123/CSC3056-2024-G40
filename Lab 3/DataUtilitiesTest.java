...
//	}
	...
	@Test
	public void testDataWithNullValues() {
	    DefaultKeyedValues2D data = new DefaultKeyedValues2D();
	    data.addValue(1, 0, 0);
	    data.addValue(null, 1, 0);
	    data.addValue(2, 0, 1);
	    double total = DataUtilities.calculateColumnTotal(data, 0);
	    assertEquals("Total should be 1.0", 1.0, total, 0.0000001d);
	}
	...
	@Test
	public void testDataWithNullValuesForRowTotal() {
	    DefaultKeyedValues2D data = new DefaultKeyedValues2D();
	    data.addValue(1, 0, 0);
	    ...
	    assertEquals("Total should be 3.0", 3.0, total, 0.0000001d);
	}
